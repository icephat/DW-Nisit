    ...
    <div class="content-body">
        ...
        <div class="col-sm-12  mx-auto">
                ...
                <div class="col-sm-12 mx-auto" >
                    <div class="card shadow mb-4">
                        ...
                        <div class="card-header  py-3">
                            <h6 class="m-0 font-weight-bold text-primary">ช่วงเกรดตามหลักสูตร</h6>
                        </div>
                        <div class="row">
            ...
            <div class="col-sm-12 mx-auto">
                <div class="card shadow mb-4">
                    <div class="card-header py-3">
                        <h6 class="m-0 font-weight-bold text-primary">ผลการเรียนนิสิตตามหลักสูตร</h6>
            ...
            <div class="col-sm-12 mx-auto">
                <div class="card shadow mb-4">
                    <div class="card-header py-3">
                        <h6 class="m-0 font-weight-bold text-primary">จำนวนนิสิตตาม Tcas ตามหลักสูตร (คน)</h6>
