        ...
        <div class="container-fluid mt-3">
            <div class="row">
                <div class="col-md-10" style="display: block; justify-content: center; align-items: center;">
                    <div class="card">
                        <div class="card-body">
                            <h5 class="card-title">เพิ่มรายวิชาทั้งหมด</h5>
                            <div class="form-validation">
                                <form class="form-valide" action="../controller/insertSubject.php" method="post"
                                    enctype="multipart/form-data">

                                    <div class="form-group row">
                                        <label class="col-lg-4 col-form-label"
                                            for="val-currency">รายวิชาทั้งหมด(csv เท่านั้น) <span
